...
let editAllowedRoles = ['superadmin', 'admin', 'rettungsdienstleiter']; // Rollen, die abgeschlossene/vergangene Tage bearbeiten dürfen
let settingsAllowedRoles = ['superadmin', 'admin', 'rettungsdienstleiter']; // Rollen, die Einstellungen sehen können
