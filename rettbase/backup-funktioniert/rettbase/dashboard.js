...
function sendAuthDataToIframe() {
    ...
    try {
        ...
        console.log(`✉️ Auth-Daten (Role: ${userAuthData.role}, Company: ${userAuthData.companyId}), ${userModules.length} Module und ${visibleMenuItems.length} Menüpunkte gesendet.`);
    } catch (error) {
 ...
 * Konvertiert "rettungsdienstleitung" zu "rettungsdienstleiter" etc.
 */
