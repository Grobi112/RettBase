...
/// Einstellungen für Schnittstellenmeldung – QM-Beauftragter E-Mail-Adressen
class SchnittstellenmeldungEinstellungenScreen extends StatefulWidget {
  final String companyId;
  final VoidCallback? onBack;

  const SchnittstellenmeldungEinstellungenScreen({
    super.key,
  ...
  @override
  State<SchnittstellenmeldungEinstellungenScreen> createState() =>
      _SchnittstellenmeldungEinstellungenScreenState();
}

class _SchnittstellenmeldungEinstellungenScreenState
    extends State<SchnittstellenmeldungEinstellungenScreen> {
  final _service = SchnittstellenmeldungConfigService();
          ...
          : SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Bei neuen Schnittstellenmeldungen können diese Adressen benachrichtigt werden.',
